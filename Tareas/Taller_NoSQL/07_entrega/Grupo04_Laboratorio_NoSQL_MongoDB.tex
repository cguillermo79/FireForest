...
\author{
\textbf{Grupo 04}\\[0.2cm]
Malan Mullo, Marco Vinicio\\
Pujos Culque, Viviana Isabel\\
Chuncho Morocho, Carlos Guillermo\\[0.2cm]
Proyecto FireForest (componente NoSQL independiente)
}
...
\section{Capturas de Resultados}

% =========================================================
% PÁGINA 1 - CAPTURAS 1 A 4
% =========================================================
\begin{figure}[H]
    \centering
    ...
    \begin{minipage}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{1Conteo105.png}
        \captionof{figure}{Conteo de documentos registrados en la colección.}
        \label{fig:conteo105}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{2DocumentoCompleto.png}
        \captionof{figure}{Visualización de un documento completo.}
        \label{fig:documentoCompleto}
    \end{minipage}
    ...
    \begin{minipage}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{3Consulta1Filtro.png}
        \captionof{figure}{Resultado de la Consulta 1 mediante filtro.}
        \label{fig:consulta1}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{4Pipelinepormes.png}
        \captionof{figure}{Resultado del pipeline de agregación por mes.}
        \label{fig:pipelineMes}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{5Pipelineporanio.png}
        \captionof{figure}{Resultado del pipeline de agregación por año.}
        \label{fig:pipelineAnio}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{6_1Actualizacion1.png}
        \captionof{figure}{Primera actualización de la información.}
        \label{fig:actualizacion1}
    \end{minipage}
    ...
    \begin{minipage}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{6_2Actualizacion2.png}
        \captionof{figure}{Segunda actualización de la información.}
        \label{fig:actualizacion2}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{6_3Actualizacion3.png}
        \captionof{figure}{Tercera actualización de la información.}
        \label{fig:actualizacion3}
    \end{minipage}
\end{figure}
