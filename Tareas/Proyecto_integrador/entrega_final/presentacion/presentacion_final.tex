...
\begin{frame}{Salto de Escala: De 2 Celdas a la Malla Cantonal Completa}
  \begin{columns}
    ...
    \begin{column}{0.52\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{figuras/mapa_7997_celdas_loja.png}\\
...
\begin{frame}{Procesamiento Distribuido en Apache Spark (PySpark)}
  \begin{columns}[t]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \end{alertblock}
      \centering
      \includegraphics[width=0.99\textwidth]{figuras/serie_temporal_clima_vs_incendios.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Conclusiones y Trabajo Futuro}
  ...
  \end{alertblock}
  \vspace{0.2cm}
  \begin{block}{Trabajo Futuro}\footnotesize
