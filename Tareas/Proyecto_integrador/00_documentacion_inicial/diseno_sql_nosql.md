...
> **Nota de corrección (2026-09-13):** la consulta mensual de referencia
> (`03_postgresql_postgis/consultas/consulta_01_incendios_clima_mensual.sql`)
> se corrigió para usar `clima_mes` como base con `LEFT JOIN` hacia
> `incendio_mes` (antes usaba `INNER JOIN`, lo que descartaba
> celda-meses con precipitación pero sin incendio). Ver el detalle y la
> validación en `../14_gestion/decisiones_metodologicas.md`.
