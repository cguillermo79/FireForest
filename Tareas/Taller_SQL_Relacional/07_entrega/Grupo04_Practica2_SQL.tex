...
\includegraphics[
    ...
    clip,
    keepaspectratio
]{../06_capturas/04_incendios_sin_precipitacion.png}
\caption{\footnotesize Resultado de la consulta ejecutada en VS Code/PostgreSQL.}
\end{figure}
\vspace{-6pt}
...
\includegraphics[
    ...
    clip,
    keepaspectratio
]{../06_capturas/05_detalle_incendios.png}
\caption{\footnotesize Resultado de la consulta ejecutada en VS Code/PostgreSQL.}
\end{figure}
\vspace{-6pt}
...
\includegraphics[
    ...
    clip,
    keepaspectratio
]{../06_capturas/07_meses_con_precipitacion.png}
\caption{\footnotesize Resultado de la consulta ejecutada en VS Code/PostgreSQL.}
\end{figure}
\vspace{-6pt}
...
\includegraphics[
    ...
    clip,
    keepaspectratio
]{../06_capturas/08_cte_incendio.png}
\caption{\footnotesize Resultado de la consulta ejecutada en VS Code/PostgreSQL.}
\end{figure}
\vspace{-6pt}
...
\includegraphics[
    ...
    clip,
    keepaspectratio
]{../06_capturas/09_extra_cobertura_vegetal.png}
\caption{\footnotesize Resultado de la consulta ejecutada en VS Code/PostgreSQL.}
\end{figure}
\vspace{-6pt}
